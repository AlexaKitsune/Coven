...
const stylize =(element_)=> document.querySelector(element_).style;
const rewriteCSS =(element_, styles_)=> document.querySelector(element_).setAttribute('style', styles_);
const stackCSS =(element_, styles_)=> document.querySelector(element_).setAttribute('style', styles_);
